...
public class RecoveryPasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RecoveryPasswordServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/recovery.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            recovery_passw_usu = usuarioDao.recoveryPasswordUsuario(usuario);
            System.out.println(recovery_passw_usu);
        } catch (Exception e) {
            mensaje = e.toString();
            e.printStackTrace();
        }
        request.setAttribute("recovery_passw_usu", recovery_passw_usu);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/recovery.jsp");
