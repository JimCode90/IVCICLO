<%@ Page Title="" Language="C#" MasterPageFile="~/DemoMaster.Master" AutoEventWireup="true" CodeBehind="WebMantProveedores.aspx.cs" Inherits="SitioWEB_VentasGUI.Mantenimientos.WebMantProveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Principal" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate >
            ...
            <div>
                <p class="tituloForm">MANTENIMIENTO DE PROVEEDORES</p>
            </div>

               <%--Boton ( o link button ) para mostrar el modal de insercion PopMant del nuevo registro--%>
            <asp:Button ID="btnNuevo" runat="server" Text="Nuevo proveedor" OnClick="btnNuevo_Click" CssClass="boton2" />
            <br />
            ...
            <br />
            <asp:GridView ID="grvProveedores" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="1031px" AutoGenerateColumns="False" CssClass="GriedView" AllowPaging="True" OnPageIndexChanging="grvProveedores_PageIndexChanging" PageSize="20" OnRowCommand="grvProveedores_RowCommand" OnRowDataBound="grvProveedores_RowDataBound" ShowHeaderWhenEmpty="True">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:ButtonField ButtonType="Image" CommandName="Editar" ImageUrl="~/Images/Editar.png" Text="Botón" />
                    <asp:BoundField DataField="Cod_prv" HeaderText="Codigo" />
