             ...
             <asp:Panel ID="PanelMan1" runat="server" CssClass="CajaDialogo" align="center" Style="display:table" Width="700">
              <table style="border: Solid 3px #D55500; height: 308px;"
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtRS1" runat="server" Width="487px" CssClass="TextBox" />
                    </td>
                </tr>
                <tr>
                    <td align="right" class="labelContenido">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtTelefono1" runat="server" Width="487px" CssClass="TextBox" />
                    </td>
                </tr>
                     ...
                     <tr>
                         ...
                         <td align="left">
                             <asp:TextBox ID="txtRuc1" runat="server" CssClass="text-box-new-large" Height="16px" Width="207px" />
                         </td>
                     </tr>
                     <tr>
                         <td align="right" class="labelContenido">Departamento</td>
                         <td align="left">
                             <asp:DropDownList ID="cboDepartamento1" runat="server">
                             </asp:DropDownList>
                         </td>
                  </tr>
                     <tr>
                         ...
                         <td align="left">
                             <asp:DropDownList ID="cboProvincia1" runat="server">
                             </asp:DropDownList>
                         </td>
                  </tr>
                     <tr>
                         ...
                         <td align="left">
                             <asp:DropDownList ID="cboDistrito1" runat="server">
                             </asp:DropDownList>
                         </td>
                  </tr>
                     <tr>
                         ...
                         <td align="left">
                             <asp:TextBox ID="txtRepVen1" runat="server" CssClass="text-box-new-large" Height="16px" Width="207px" />
                         </td>
                  </tr>
                  <tr>
                      <td align="right" class="auto-style1">Estado</td>
